...
public class loginsignupcontroller {
    ...
    private void initialize() {
        ...
        ChangeQuestion1.setOnMouseClicked(Event -> {
            ...
            } while (Question1.getPromptText().equals(Question2.getPromptText()) || Question1.getPromptText().equals(Question3.getPromptText()));
        });
        ChangeQuestion2.setOnMouseClicked(Event -> {
            do {
                UtilLogicFun.GetQUestionRememberPassword(Question2);
            } while (Question2.getPromptText().equals(Question1.getPromptText()) || Question2.getPromptText().equals(Question3.getPromptText()));
        });
        ChangeQuestion3.setOnMouseClicked(Event -> {
            do {
                UtilLogicFun.GetQUestionRememberPassword(Question3);
            } while (Question3.getPromptText().equals(Question1.getPromptText()) || Question3.getPromptText().equals(Question2.getPromptText()));
    ...
    private void LoginControlQuestionAndEnter() {
        ...
        if (!Question1.getText().trim().isEmpty() || !Question3.getText().trim().isEmpty() || !Question3.getText().isEmpty()) {
            ...
            ErrorQuestion.setText("non lasciare le domande vuote!\n piuttosto cambia domanda con i pulsanti li accanto");
        }
